...
int main()
{
  ...
  while (ifs1>>tipusjocproves) {
    ...
    if (tipusjocproves==0) {
      string command="./cl <"+jpfile+" >analysisoutput";
      system(command.c_str());
      if (human) infopantalla<<jpfile<<":\t";
      set<string> jplines=read_error_lines("analysisoutput");
