...
#endif
{
  ...
  dec_proc_header(zzSTR); zzlink(_root, &_sibling, &_tail);
  dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
  l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
  l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
...
void
#ifdef __USE_PROTOS
dec_proc_header(AST**_root)
#else
dec_proc_header(_root)
AST **_root;
#endif
{
  zzRULE;
  ...
  l_params_dec(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  dec_func_header(zzSTR); zzlink(_root, &_sibling, &_tail);
  dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
  l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
  l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
...
void
#ifdef __USE_PROTOS
dec_func_header(AST**_root)
#else
dec_func_header(_root)
AST **_root;
#endif
{
  zzRULE;
...
#endif
{
  ...
  {
  {
    ...
    {
    if ( (LA(1)==TYPEPARAM) ) {
      param_dec(zzSTR); zzlink(_root, &_sibling, &_tail);
      {
        zzBLOCK(zztasp3);
        zzMake0;
        {
      ...
      if ( (setwd3[LA(1)]&0x10) ) {
        {
          ...
          }
          {
            ...
            while ( (LA(1)==OPENCLAU) ) {
              ...
              exp2(zzSTR); zzlink(_root, &_sibling, &_tail);
              zzmatch(CLOSECLAU);  zzCONSUME;
              {
                zzBLOCK(zztasp5);
                zzMake0;
...
#endif
{
  ...
  zzMake0;
  {
  exp3(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
    ...
    while ( (setwd4[LA(1)]&0x8) ) {
      {
        ...
        {
        if ( (LA(1)==OPENARROW) ) {
          zzmatch(OPENARROW); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
        }
        else {
          if ( (LA(1)==CLOSEARROW) ) {
            zzmatch(CLOSEARROW); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
          }
          else {
            if ( (LA(1)==EQUAL) ) {
...
#endif
{
  ...
  zzMake0;
  {
  exp1(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
